					   ...
					   <div class="offset2">
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-left"><i class="icon-user"></i>&nbsp;Staff change Password</div>
                            ...
                            <div class="block-content collapse in">
								...
								<?php
								$query = mysql_query("select * from staff where staff_id = '$session_id'")or die(mysql_error());
