...
mysql_query("insert into student (FirstName,SecondName,Othername,RegNo,PlaceOfBirth,YearAdmitted,YearOut,YearOfBirth,Mobile,PostalCode,PAddress,KCPEMarks) 
values('$firstname','$Secondname','$othername','$RegNo','$PlaceOfBirth','$YearIn','$YearOut','$YearOfBirth','$Contacts','$postalCode','$PostAddress','$KCPEMEAN')")or die(mysql_error());
