								...
								<form action="delete_users.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
												...
												<td width="120">
												<a rel="tooltip"  title="Edit Client" id="<?php echo $id; ?>" href="edit_user.php<?php echo '?id='.$id; ?>"  data-toggle="modal" class="btn btn-success"><i class="icon-pencil icon-large"> Edit User</i></a>
												</td>
