<div class="row-fluid">				  
   <a href="staff_user.php" class="btn btn-info" id="add" data-placement="right" title="Click to Add New" ><i class="icon-plus-sign icon-large"></i> Add New  Staff</a>
	...
	$('#add').tooltip('hide');
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-pencil icon-large"></i> Edit Staff Info.</div>
                            </div>
...
mysql_query("update staff set username = '$username'  , firstname = '$firstname' , lastname = '$lastname' where staff_id = '$get_id' ")or die(mysql_error());

mysql_query("insert into activity_log (date,username,action) values(NOW(),'$admin_username','Edit staff User $firstname')")or die(mysql_error());	
?>
<script>
  window.location = "staff_user.php";
 $.jGrowl(" User Successfully Update", { header: 'Staff User Update' });  
</script>
<?php
}
?>