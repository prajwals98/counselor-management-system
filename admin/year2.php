    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_student=mysql_query("select * from year1 where yr='2nd Year' ");
...
<div class="block-content collapse in">
	...
	<form action="" method="post">
  	<table class="table table-striped table-bordered table-hover" cellpadding="0" cellspacing="0" border="0" class="table" id="example" id="dataTables-example" >
                                    ...
                                    <?php
									$student_query = mysql_query("select * from year1 where yr = '2nd Year' ")or die(mysql_error());
									...
									$RegNo = $row['usn'];
                                        ...
                                        <tr class="odd gradeX">
											...
											<td><?php echo $row['DOB']; ?></td>	
                                             ...
                                             <a href="viewyear2.php?del=<?php echo $row['usn']; ?>"> <p class="fa fa-times-circle"></p></td>
