    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_student=mysql_query("select * from year1 where usn = '$get_id' ");
				...
				<?php
								$query = mysql_query("select * from year3 where usn = '$get_id'")or die(mysql_error());
		   ...
		   <a href="year1.php" class="btn btn-info" id="print" data-placement="right" title="Back">Back</a> 		      
		   <script type="text/javascript">
		     $(document).ready(function(){
		     $('#print').tooltip('show');
		     $('#print').tooltip('hide');
	...
	<br><br><br><br>		
		 ...
		 <div class="row">
          ...
          <tr> 
		   ...
		   <a href="year1.php" class="btn btn-info" id="print" data-placement="center" title="Back"> Back</a> 		      
