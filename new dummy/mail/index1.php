...
// don't change the quotes!					//Sets SMTP authentication. Utilizes the Username and Password variables
	$mail->Username = 'prajwals.devang.98@gmail.com';					//Sets SMTP username
	$mail->Password = 'prajwal@1998';					//Sets SMTP password
	$mail->SMTPSecure = '';							//Sets connection prefix. Options are "", "ssl" or "tls"
	$mail->From = $_POST["email"];					//Sets the From email address for the message
	$mail->FromName = $_POST["name"];				//Sets the From name of the message
	$mail->AddAddress('prajwals.devang.98@gmail.com', 'prajwal s');		//Adds a "To" address
