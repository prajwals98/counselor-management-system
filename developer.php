                     ...
                     <div class="row-fluid">
                        ...
                        <div class="block">
							...
							<div class="span3"></div>
                                ...
                                <div class="span3" >
										<center>
								        <img id="developers" src="admin/developers/admin1.jpg" class="img-circle">
								        <hr>
										<p>Name: Deepesh Chhadva</p>
										<p>Address: Bangalore</p>
										<p>Email:<a href="http://www.gmail.com"> deepeshchhadva@gmail.com</a></p>
								        </center>
								</div>
								<div class="span3" >
										<center>
								        <img id="developers" src="admin/developers/admin2.jpg" class="img-circle">
								        <hr>
										<p>Name: Bhargav S</p>
										<p>Address: Bangalore</p>
										<p>Email:<a href="http://www.gmail.com"> bhargavs2493@gmail.com</a></p>
								        </center>
								</div>
								</p>
