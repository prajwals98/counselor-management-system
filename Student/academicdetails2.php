				   ...
				   <body>
					  ...
					  <!-- block -->
                        <div id="block_bg" class="block">
							...
							<h1 align="center">INTERNAL ASSESSMENT FOR 3RD YEAR</h1>
...
<?php
								$query = mysql_query("select * from marks1 where usn='$staff_fullname'")or die(mysql_error());
			...
			<div class="panel-heading"><center><b style="color:darkblue">INTERNAL MARKS FOR 5th SEMESTER</center></b></div>
...
<div class="row">
			<div class="col-lg-12">
			<div class="panel panel-default">
			<div class="panel-heading"><center><b style="color:darkblue">INTERNAL MARKS FOR 6th SEMESTER</center></b></div>
			<div class="panel-body">
			<div class="row">
...
<div class="col-lg-6">
			 <th> Total	</th>
                  ...
                  <div class="col-lg-6">
			<td><input class="form-control"  name="t1s12" value="<?php echo $row['t1s11']; ?>"></td>
			</div>
            <div class="col-lg-6">
			<td><input class="form-control"  name="t1s22" value="<?php echo $row['t1s21']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control"  name="t1s32" value="<?php echo $row['t1s31']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control"  name="t1s42" value="<?php echo $row['t1s41']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control"  name="t1s52" value="<?php echo $row['t1s51']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control"  name="t1s62" value="<?php echo $row['t1s61']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control"  name="t1s72" value="<?php echo $row['t1s71']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control"  name="t1s82" value="<?php echo $row['t1s81']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control"  name="t1total2" value="<?php echo $row['t1total1']; ?>"></td>
			</div>
                  </tr>
          ...
          <tr> 
                  ...
                  <div class="col-lg-6">
			<td><input class="form-control" name="t2s12" value="<?php echo $row['t2s11']; ?>"></td>
			</div>
            <div class="col-lg-6">
			<td><input class="form-control" name="t2s22" value="<?php echo $row['t2s21']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="t2s32" value="<?php echo $row['t2s31']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="t2s42" value="<?php echo $row['t2s41']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="t2s52" value="<?php echo $row['t2s51']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="t2s62" value="<?php echo $row['t2s61']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="t2s72" value="<?php echo $row['t2s71']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="t2s82" value="<?php echo $row['t2s81']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="t2total2" value="<?php echo $row['t2total1']; ?>"></td>
			</div>
                  </tr>
 ...
 <tr> 
                  ...
                  <div class="col-lg-6">
			<td><input class="form-control" name="t3s12" value="<?php echo $row['t3s11']; ?>"></td>
			</div>
            <div class="col-lg-6">
			<td><input class="form-control" name="t3s22" value="<?php echo $row['t3s21']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="t3s32" value="<?php echo $row['t3s31']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="t3s42" value="<?php echo $row['t3s41']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="t3s52" value="<?php echo $row['t3s51']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="t3s62" value="<?php echo $row['t3s61']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="t3s72" value="<?php echo $row['t3s71']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="t3s82" value="<?php echo $row['t3s81']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="t3total2" value="<?php echo $row['t3total1']; ?>"></td>
			</div>
                  </tr>
				  <tr> 
                  <div class="col-lg-6">
                  ...
                  <div class="col-lg-6">
			<td><input class="form-control" name="a1s12" value="<?php echo $row['a1s11']; ?>"></td>
			</div>
            <div class="col-lg-6">
			<td><input class="form-control" name="a1s22" value="<?php echo $row['a1s21']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="a1s32" value="<?php echo $row['a1s31']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="a1s42" value="<?php echo $row['a1s41']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="a1s52" value="<?php echo $row['a1s51']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="a1s62" value="<?php echo $row['a1s61']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="a1s72" value="<?php echo $row['a1s71']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="a1s82" value="<?php echo $row['a1s81']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="a1total2" value="<?php echo $row['a1total1']; ?>"></td>
			</div>
                  </tr>
				  <tr> 
                  <div class="col-lg-6">
                  ...
                  <div class="col-lg-6">
			<td><input class="form-control" name="as1s12" value="<?php echo $row['as1s11']; ?>"></td>
			</div>
            <div class="col-lg-6">
			<td><input class="form-control" name="as1s22" value="<?php echo $row['as1s21']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="as1s32" value="<?php echo $row['as1s31']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="as1s42" value="<?php echo $row['as1s41']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="as1s52" value="<?php echo $row['as1s51']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="as1s62" value="<?php echo $row['as1s61']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="as1s72" value="<?php echo $row['as1s71']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="as1s82" value="<?php echo $row['as1s81']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="as1total2" value="<?php echo $row['as1total1']; ?>"></td>
			</div>
                  </tr>
				  <tr> 
                  <div class="col-lg-6">
                  ...
                  <div class="col-lg-6">
			<td><input class="form-control" name="f1s12" value="<?php echo $row['f1s11']; ?>"></td>
			</div>
            <div class="col-lg-6">
			<td><input class="form-control" name="f1s22" value="<?php echo $row['f1s21']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="f1s32" value="<?php echo $row['f1s31']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="f1s42" value="<?php echo $row['f1s41']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="f1s52" value="<?php echo $row['f1s51']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="f1s62" value="<?php echo $row['f1s61']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="f1s72" value="<?php echo $row['f1s71']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="f1s82" value="<?php echo $row['f1s81']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="f1total2" value="<?php echo $row['f1total1']; ?>"></td>
			</div>
                  </tr>
				  <tr> 
                  <div class="col-lg-6">
                  ...
                  <div class="col-lg-6">
			<td><input class="form-control" name="e1s12" value="<?php echo $row['e1s11']; ?>"></td>
			</div>
            <div class="col-lg-6">
			<td><input class="form-control" name="e1s22" value="<?php echo $row['e1s21']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="e1s32" value="<?php echo $row['e1s31']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="e1s42" value="<?php echo $row['e1s41']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="e1s52" value="<?php echo $row['e1s51']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="e1s62" value="<?php echo $row['e1s61']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="e1s72" value="<?php echo $row['e1s71']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="e1s82" value="<?php echo $row['e1s81']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="e1total2" value="<?php echo $row['e1total1']; ?>"></td>
			</div>
                  </tr>
				  <tr> 
                  <div class="col-lg-6">
                  ...
                  <div class="col-lg-6">
			<td><input class="form-control" name="totals12" value="<?php echo $row['total11']; ?>"></td>
			</div>
            <div class="col-lg-6">
			<td><input class="form-control" name="totals22" value="<?php echo $row['total21']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="totals32" value="<?php echo $row['total31']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="totals42" value="<?php echo $row['total41']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="totals52" value="<?php echo $row['total51']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="totals62" value="<?php echo $row['total61']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="totals72" value="<?php echo $row['total71']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="totals82" value="<?php echo $row['total81']; ?>"></td>
			</div>
			<div class="col-lg-6">
			<td><input class="form-control" name="total2" value="<?php echo $row['total1']; ?>"></td>
			</div>
                  </tr>
...
$result = mysql_query("select sc1 from marks1 where usn = '$staff_fullname'");
if(mysql_num_rows($result)==0)
{
mysql_query("INSERT INTO marks1 VALUES('$usn',
'$sc11', 	   
'$sc21', 	   
'$sc31', 	   
'$sc41', 	   
