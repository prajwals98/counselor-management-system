	 ...
	 <div class="span3" id="sidebar">
                  ...
                  <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						 ...
						 <li>						
                            ...
                            <li class="">
                            <a href="#"></i></i> Stundents Details</a>
                            </li>
                            <li class="">
                            <a href="#"></i><i class="icon-folder-open-alt"></i> Examination</a>
                            </li> 
						    <li>
                            <a href="#"><i class="icon-chevron-right"></i><i class="icon-laptop"></i> Assign&nbsp;<span class="label label-success">New</span>&nbsp;Records
					    ...
					    <li>						
						    <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs1"><i class="icon-chevron-right"></i><i class="icon-globe"></i>&nbsp;Finance
							<div class="muted pull-right"><i class="caret"></i></div></a>						
						    <ul id="bs1" class="collapse">						
                            <li class="">
                            <a href="#"><i class="icon-chevron-right"></i><i class="icon-file"></i> Paid Fees</a>
                            </li>
						    <li class="">
                            <a href="#"><i class="icon-chevron-right"></i><i class="icon-file"></i> Fees Balances</a>
                            </li>
							<li class="">
                            <a href="#"><i class="icon-chevron-right"></i><i class="icon-file"></i> Salaries</a>
                            </li>
							<li class="">
                            <a href="#"><i class="icon-chevron-right"></i><i class="icon-file"></i> School Budget</a>
                            </li>
							<li class="">
                            <a href="#"><i class="icon-chevron-right"></i><i class="icon-file"></i> Miscellaneous</a>
                            </li>
						    </ul>
						</li>
					  ...
					  <!------/.* manage System user sidebar*------->	
						<li>						
                            ...
                            <li class="">
                            <a href="staff_user.php"></i>&nbsp;Staff</a>
                            </li>
						    <li class="">
                            <a href="admin_user.php"></i>&nbsp;System User</a>
                            </li>
						    </ul>
						</li>
